...
//		Select the age group (only if not selected)
		WebElement ageGroup = driver.findElement(By.xpath("//h5[text()='Select the age group (only if not selected)']//following-sibling::div//div/label[contains(text(), '21-40 Years')]"));
		WebElement group = ageGroup.findElement(By.xpath("./preceding-sibling::div/div[2][contains(@class,'ui-radiobutton-box')]"));
			if(!group.getDomAttribute("class").contains("ui-state-active")){
				ageGroup.click();
