...
//		actions.dragAndDropBy(left2, -23, 0).build().perform();
		
//		Resize image
		WebElement image = driver.findElement(By.xpath("//div[@class='ui-wrapper']"));
		int width = image.getSize().getWidth();
		int height = image.getSize().getHeight();
		System.out.println("widhth "+width+", height " +height);
		actions.clickAndHold(image).moveByOffset(72, 72).release().build().perform();
