...
//		Select 'Two' irrespective of the language chosen
		...
		Thread.sleep(1000);
		List<WebElement> countList = driver.findElements(By.xpath("//ul[@id='j_idt87:value_items']/li"));
		
		for (WebElement countTwo : countList) {
			if(countTwo.getText().equals("Two") || countTwo.getText().equals("இரண்டு") || countTwo.getText().equals("రెండు") 
					|| countTwo.getText().equals("ಎರಡು") || countTwo.getText().equals("രണ്ട്") || countTwo.getText().equals("दो")) {
				countTwo.click();
			}
